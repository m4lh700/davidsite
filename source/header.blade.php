  ...
  <div class="bg-red-600 flex">
    <div class="container mx-auto px4 mx8">
      <div class="flex flex-col p-4 md:p-32 m-auto animate__animated animate__fadeIn">
        ...
        <h1 class="hidden md:block text-xl md:text-5xl text-white font-bold text-center uppercase leading-relaxed">{!! $maintitle !!}</h1>
        <h2 class="hidden md:block md:text-5xl text-white font-thin text-center leading-relaxed">{!! $subtitle !!}</h2>
