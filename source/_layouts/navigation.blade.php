  ...
  <div class="container mx-auto">
    <nav class="bg-red-500 dark:bg-gray-800">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <button id="menu-btn" data-collapse-toggle="mobile-menu" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-white rounded-lg md:hidden">
        ...
        <div class="hidden w-full h-full md:block md:w-auto transition ease-in-out duration-300" id="mobile-menu">
          <!-- Menu items -->
