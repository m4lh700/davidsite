<div class="bg-theme-black h-screen" id="home">
    <div class="container mx-auto px4 pt-12 mx8 flex justify-between flex-wrap flex-1">
        <h3 class="flex-row text-3xl font-bold text-white text-center">FIRST SECTION</h3>
